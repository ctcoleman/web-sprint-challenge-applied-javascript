...
axios.get(articlesURL)
  .then((value) => {
    ...
    const bootstrapCard = createCard(bootstrap)
    const bootstrapCard = createCard(javascript)
    const bootstrapCard = createCard(jquery)
    const bootstrapCard = createCard(node)
    const bootstrapCard = createCard(technology)
