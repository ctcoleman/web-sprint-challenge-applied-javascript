...
1. What is the DOM?
  The DOM is the Document Object Model. It is a virtual tree of objects and nodes so that programming languages may edit and display features of the DOM to the browser. The DOM brings together the HTML source and the 
2. What is an event?
